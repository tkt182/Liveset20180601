...
void main (void)
{
    ...
    //if(pos.y < yrand){
    //float ybase = sin((20.0 * pos.y/float(trueHeight))) - 1.0;
    float ybase = sin((20.0 * rand * pos.y/float(trueHeight))) - 1.0;
    
    //if(ybase * rand2 < -1.0){
    if(ybase * rand2 < rand - 1.0){
    ...
    col_s1[0] = (col_s1[0] + col_s1[1] + col_s1[2] + col_s1[3] + col_s1[4])/6.0;
    col_s2[0] = (col_s2[0]+ col_s2[1]+ col_s2[2]+ col_s2[3]+ col_s2[4])/6.0;
